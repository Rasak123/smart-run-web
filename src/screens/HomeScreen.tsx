        ...
        >
          ...
          <Grid container spacing={2}>
            <Grid item xs={4} sx={{ display: 'flex', alignItems: 'center' }}>
              <QueryStats sx={{ mr: 1, color: 'text.secondary' }} fontSize="small" />
              <Box>
                <Typography variant="body2" color="text.secondary">
                  Time
                </Typography>
            ...
            <Grid item xs={4} sx={{ display: 'flex', alignItems: 'center' }}>
              <EmojiEvents sx={{ mr: 1, color: 'text.secondary' }} fontSize="small" />
              <Box>
                <Typography variant="body2" color="text.secondary">
                  Distance
                </Typography>
            ...
            <Grid item xs={4} sx={{ display: 'flex', alignItems: 'center' }}>
              <DirectionsRun sx={{ mr: 1, color: 'text.secondary' }} fontSize="small" />
              <Box>
                <Typography variant="body2" color="text.secondary">
                  Pace
                </Typography>
